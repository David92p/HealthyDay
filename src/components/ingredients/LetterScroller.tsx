import { 
	faA, faB, faC, faD, faE, faF, faG, faH, faI, faJ, faK, faL, faM, faN, faO, faP, faQ, faR, faS, faT, faU, faW, faX, faY, faZ, faArrowRight, 
...
const LetterScroller:React.FC<LetterScrollerlType> = ({scrool, setScrool}) => {
  ...
  return (
		<>
			<div className='flex w-full h-48 bg-pink-100'>
				<div className='flex justify-center items-center w-1/5 border-4 border-red-500'>
					<FontAwesomeIcon icon={letters[scrool[2]]} className='text-2xl' />
				</div>
				<div className='flex justify-center items-center w-3/5 border-4 border-red-500'>
					<FontAwesomeIcon icon={letters[scrool[0]]} bounce className='text-7xl' />
				</div>
				<div className='flex justify-center items-center w-1/5 border-4 border-red-500'>
