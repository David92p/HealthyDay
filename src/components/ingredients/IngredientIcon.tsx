...
const IngredientIcon:React.FC<IngredientType> = ({id, name, image}) => {
  ...
  return (
    <div onClick={() => navigate(`/ingredienti/dettaglio/${id}`)} className='flex flex-col items-center gap-4 rounded-xl w-40 sm:w-52 h-auto p-2 bg-mypink border-2 border-blue-500'>
