...
const Start:React.FC<SequenceType> = ({toggleSequence}) => {
  ...
  return (
		...
		>
			<span className='text-mygreen text-3xl sm:text-5xl 2xl:text-7xl'>Let's start right here!</span>
			...
			<div className='flex justify-center items-center h-full'>
				<button onClick={() => toggleSequence("timeFrame")} className='bg-mypink text-mygreen w-40 h-auto py-4 rounded-md text-2xl text-bold'>Start your plan!</button>
			</div>
		</div>
  )
}
