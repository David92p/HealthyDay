...
const ToolLabel:React.FC<RecipeToolType> = ({name, measures, image}) => {
  return (
    <div className='flex flex-col justify-between sm:justify-center 2xl:justify-between sm:gap-4 2xl:gap-0 items-center w-40 sm:w-52 h-auto p-2 2xl:py-4 bg-mypink 2xl:cursor-pointer'>
