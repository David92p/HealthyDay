  ...
  return (
   <div className='flex flex-col border-6 border-blue-600' style={{fontFamily: "Salsa"}}>
      ...
      <div className='relative h-64 sm:h-80 2xl:h-[400px] w-full'>
        ...
        <h1 style={{fontFamily: "Salsa"}} className='text-white absolute top-0 ml-4 sm:ml-10 2xl:mx-16 mt-4 text-sm sm:text-2xl 2xl:text-lg'>Buongiorno Salute</h1>
      ...
      {/* introduzione */}
      <div className='flex flex-col sm:flex-row h-auto sm:h-[600px] w-full bg-greenbox pt-8 sm:pt-16 2xl:pt-24 px-4 sm:px-10 2xl:px-16'>
      ...
      <div className='flex flex-col sm:flex-row-reverse h-auto 2xl:h-[700px] w-full bg-slate-100 pt-8 sm:pt-16 2xl:pt-24 px-4 sm:px-10 2xl:px-16'>
        ...
        <div className='flex flex-col sm:w-2/5 2xl:w-1/3 text-greenbox mt-6 sm:mr-5'>
          <span className='text-3xl sm:text-5xl 2xl:text-7xl'>Inizia da quì</span>
          <span className='text-xl sm:text-3xl mt-4'>Lavoriamo tutti insieme per portare sulla tua tavola il gusto della salute.<br/>Prova le nostre specilità iniziano da quì.</span>
          <br />
          <ul className='text-xl sm:text-3xl list-disc ml-6'>
            <li className='mb-2'>Sano come tu vuoi</li>
            <li className='mb-2'>Vitamine per la mente e il corpo</li>
            <li className='mb-2'>Proteine di qualità.</li>
            <li>Scegli il tuo sapore</li>
          </ul>
          <button className='bg-mypink w-36 sm:w-40 h-8 sm:h-10 rounded-sm mx-auto my-6 text-xl sm:text-3xl'>Inizia</button>
        </div>
      </div>
      {/* spazio pasti 3 card  */}
      <div className='flex flex-col sm:flex-row sm:h-[700px] w-full bg-slate-100 pt-8 sm:py-16 px-4 sm:px-10 2xl:px-16 sm:gap-4 text-xl sm:text-3xl text-greenbox'>
        ...
        <div className='flex flex-col sm:w-1/3 my-4 sm:my-0'>
      ...
      <div className='flex flex-col sm:flex-row h-auto 2xl:h-[600px] w-full bg-greenbox py-8 sm:py-16 2xl:py-24 px-4 sm:px-10 2xl:px-16 tracking-wider'>
      ...
      {/* footer e contatti */}
      <div className='flex flex-col bg-mypink w-full h-auto  text-greenbox pt-6 sm:pt-14 2xl:pt-16'>
        ...
        <div className='flex w-full mt-8'>
          <div className='w-1/3 flex flex-col justify-start text-center'>
            <span className='text-2xl sm:text-4xl 2xl:text-6xl text-center'>Seguici</span>
            <div className='flex gap-4 w-full justify-center mt-2 pl-2 mb-5'>
          ...
          <div className='w-1/3 flex flex-col justify-start text-center'>
            <span className='text-2xl sm:text-4xl 2xl:text-6xl'>Indirizzo</span>
          ...
          <div className='w-1/3 flex flex-col justify-start text-center'>
            <span className='text-2xl sm:text-4xl 2xl:text-6xl'>Contattaci</span>
            <FontAwesomeIcon icon={faEnvelope}/>
          </div>
        </div>
        <div className='flex items-end justify-center pt-4 w-full h-full'>© 2024 | Davide Panetta</div>
      </div>
   </div> 
  )
}
