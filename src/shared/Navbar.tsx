...
const Navbar:React.FC = () => {
  ...
  return (
    <div className='flex flex-col w-full h-48 sm:h-64 2xl:h-[500px] relative cursor-default' style={{fontFamily: "Salsa"}}>
      ...
      <h1 style={{fontFamily: "Salsa"}} className='text-slate-100 absolute w-full text-end mt-4 pr-4 sm:pr-6 2xl:pr-10 text-xl sm:text-4xl opacity-100' onClick={() => navigate("/")}>Buongiorno Salute</h1>
